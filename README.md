...
- Leading a team of **10 developers** since 2023
- Programming in **C#, PowerShell, MSSQL T-SQL, TypeScript**
- Designed and maintained automated CI/CD pipelines using **Azure DevOps**
...
- 2023 - 🚑 Prehospital Trauma Life Support (PHTLS)
- 2023 - 🚑 Treatment of Polytraumatized Patients in Practice
...
## Key projects
### E.ON – ECM Modernization and Integration
**Description**  
Comprehensive modernization and development of the existing ECM system using the latest OpenText technologies such as Extended ECM for SAP Solutions for deep integration with enterprise systems, Content Server for content management, Document Pipeline for efficient document processing and distribution, and Archive Center for secure archiving.

These technologies enabled increased efficiency of document management, improved information accessibility, and reduced maintenance costs through better resource utilization. The solution also enhanced data security and reliability while making the system more flexible and scalable for future growth. Overall, this led to improved user satisfaction, enabling faster and easier access to essential business documents.

**Technologies used:**  
OpenText Extended ECM for SAP Solutions, OpenText Content Server, OpenText Document Pipeline, OpenText Archive Center

**Responsibility** – Solution architecture, implementation supervision, integration with SAP and 3rd party systems, modernization planning
